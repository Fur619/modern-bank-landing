  ...
  return (
    <section id="product" className={layout.sectionReverse}>
      <div className={layout.sectionImgReverse}>
        ...
        <div className="absolute z-[3] -left1/2 top-0 w-1/2 h-1/2 rounded-full white__gradient" />
        <div className="absolute z-[0] -left1/2 bottom-0 w-1/2 h-1/2 rounded-full pink__gradient" />
      </div>
