    ...
    return (
        <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            <div className={`flex-1 flex-col xl:px-0 sm-px-16 px-6 ${styles.flexStart}`}>
                <div className={`flex items-center gap-x-2 py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2`}>
                ...
                <p className={`${styles.paragraph} max-w-[480px] mt-10`}>Our team of experts uses a methodology to identify the credit cards most likely to fit your needs.
